...
smorty can be found in
/new-project-name/web/profiles/contrib/bene/themes/smorty
where new-project-name is your project.

smorty can be found in a project called "new-project-name" here:
/new-project-name/web/profiles/contrib/bene/themes/smorty
...
- Set `smorty` as the default theme.
